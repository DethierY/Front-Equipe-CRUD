...
CREATE TABLE `suspect` (
  ...
  `couleur_cheveux` varchar(15) DEFAULT NULL,
  `couleur_peau` varchar(15) DEFAULT NULL,
  `photo` varchar(255) DEFAULT NULL,
  `pseudo` varchar(40) DEFAULT NULL,
  `signe_particulier` varchar(255) DEFAULT NULL,
  `taille` varchar(10) DEFAULT NULL,
  `id_affaire` bigint(20) NOT NULL,
  `id_personne` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKhn4rst6j0j8uoblyc5ffu0q63` (`id_affaire`),
  KEY `FK1ojq78dv3ig8koh41nrmcas3p` (`id_personne`)
